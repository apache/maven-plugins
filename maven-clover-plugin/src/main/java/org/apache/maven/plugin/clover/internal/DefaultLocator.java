...
/**
 * Performs DefaultLocator services for the <code>*Location</code> parameters in the Reports.
 *
 * Note: This class was copied from the PMD plugin. We need to create a reusable library
 * (see http://jira.codehaus.org/browse/MNG-2183).
 *
