...
{/*
        ...
        throws InvalidVersionSpecificationException
    {
        ...
        // test ranges
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.5,)" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.4,)" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.4,2.0.5]" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.4,2.0.6]" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.4,2.0.6)" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0,)" ), version ) );
        assertTrue( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.0,)" ), version ) );
        // not matching versions
        assertFalse( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.4,2.0.5)" ), version ) );
        assertFalse( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "[2.0.6,)" ), version ) );
        assertFalse( EnforceMojo.containsVersion( VersionRange.createFromVersionSpec( "(2.0.5,)" ), version ) );
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        catch ( Exception e )
        {
            ...
            {
                fail( "Received wrong exception. Expected MojoExecutionException. Received:" + e.toString() );
            }
        }
