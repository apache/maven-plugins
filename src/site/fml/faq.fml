...
<faqs xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <part id="General">
    ...
    <faq id="Why are not all developers/contributors listed in the DOAP file as maintainer">
      <question>Why are not all developers/contributors listed in the DOAP file as maintainer?</question>
      <answer>
        <p>Developers/contributors having a role containing "<i>emeritus</i>" are no longer active in the
