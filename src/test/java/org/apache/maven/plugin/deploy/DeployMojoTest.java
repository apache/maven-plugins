    ...
    extends AbstractMojoTestCase
{
    ...
    public void testDeployWithAttachedArtifacts()
        throws Exception
    {
        File testPom = new File( getBasedir(), "target/test-classes/unit/basic-deploy-with-attached-artifacts/"
            + "plugin-config.xml" );
        ...
        @SuppressWarnings( "unchecked" ) List<AttachedArtifactStub> attachedArtifacts = project.getAttachedArtifacts();
        ...
        throws Exception
    {
        ...
        File file = new File( getBasedir(), "target/test-classes/unit/basic-deploy-scp/target/"
            + "deploy-test-file-1.0-SNAPSHOT.jar" );
